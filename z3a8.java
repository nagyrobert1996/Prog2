...
public:
   ...
   */
   ...
   LZWBinFa (const LZWBinFa & regi): gyoker (new LZWBinFa() )//másoló konstruktor
    {
       // std::cout<<"copy constr"<<std::endl;
        gyoker=regi.gyoker;
    }

    LZWBinFa& operator=(const LZWBinFa& regi) //másoló értékadás
    {
        if (this == regi)
            return this;
    ...
    LZWBinFa (LZWBinFa&& regi) //mozgató konstruktor
    {
       // std::cout<<" copy ";
        gyoker=nullptr; //gyoker=regi.gyoker

        this=std::move(regi);
        //regi.gyoker=nullptr;
    }

    LZWBinFa& operator= (LZWBinFa&& regi) //mozgató értékadás
    {
       // std::cout<<" move ";
